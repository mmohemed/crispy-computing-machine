/** أيقونات SVG مضمّنة (بأسلوب خطي) — لا اعتماد على أي CDN */
'use strict';
...
function icon(name, cls) {
  const body = P[name] || P.code;
  return `<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"${cls ? ` class="${cls}"` : ''}>${body}</svg>`;
}
